package com.olym.mjt.widget.swipeview;
        ...
        extends ListView
{
        ...
        super.setAdapter(new SwipeMenuAdapter(getContext(), paramListAdapter)
        {
            ...
            public void onItemClick(SwipeMenuView paramAnonymousSwipeMenuView, SwipeMenu paramAnonymousSwipeMenu, int paramAnonymousInt)
            {
                if (SwipeMenuListView.this.mOnMenuItemClickListener != null) {
                    SwipeMenuListView.this.mOnMenuItemClickListener.onMenuItemClick(paramAnonymousSwipeMenuView.getPosition(), paramAnonymousSwipeMenu, paramAnonymousInt);
                }
    ...
    {
        public abstract void onMenuItemClick(int paramInt1, SwipeMenu paramSwipeMenu, int paramInt2);
    }
